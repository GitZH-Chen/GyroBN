...
from RieNets.grnets.training.utils import get_dataset_settings,optimzer,parse_cfg,train_per_epoch,val_per_epoch
import RieNets.grnets.training.utils as spdnet_utils
from RieNets.grnets.training.utils import set_seed_thread

from RieNets.grnets.models.GyroGr import GyroGr
...
def training(cfg,args):
    ...
    args.opti = optimzer(model.parameters(), lr=args.lr, mode=args.optimizer_mode,weight_decay=args.weight_decay)
    logger.info(model)
